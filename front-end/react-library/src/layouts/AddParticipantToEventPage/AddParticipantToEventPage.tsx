...
export const AddParticipantToEventPage = () => {
            ...
            <div className='p-5 container'>
                <div className='row'>
                    <div className='card col-md-6 offset-md-3 offset-md-3'>
                        <h4 className='text-left'>Osavõtjad</h4>
                        <div className='card-body'>
                            <form>
                                ...
                                {/* Participants */}
                                <div className='form-group mb-2'>
                                    <label className='form-label'>Osavõtjad:</label>
                                </div>
                            </form>
                        </div>
                        <br />

                        <h4 className='text-left'>Osavõtjate lisamine</h4>
                        <div className='card-body'>
                            <form>
                                {/* Radio buttons */}
                                <div>
                                    <label>
                                        ...
                                        Eraisik
                                        <input type="radio" value="option2" checked={false} style={{marginLeft: "10px"}}/>
                                        Ettevõte
                                    </label>
                                </div>
                                <br/>
